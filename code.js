...
function clavier(e) {
    ...
    let a=loup.dataset.x;
    let b=loup.dataset.y;
    ...
    if (damier.rows[y].cells[x].dataset.type=="mur") {
        ...
        if (damier.rows[b].cells[a].dataset.type=="mur")
            ...
            deplacerImage(loup,a,b);    
            etat.innerHTML="perso : x=" + perso.dataset.x + " y=" + perso.dataset.y;
            etat.innerHTML +="<br>loup : x=" + loup.dataset.x + " y=" + loup.dataset.y;
            etat.focus();
            if (a==x && b==y) {
                document.body.removeEventListener("keydown",clavier);
                perso.parentElement.removeChild(perso);
                damier.innerHTML="";
                loup.style.width="500px";
                loup.style.height="500px";
                document.body.appendChild(loup);
...
let loup=creerImage("loup.png","loup");
